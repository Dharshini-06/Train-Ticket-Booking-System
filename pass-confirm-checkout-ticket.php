<?php
    ...
    if(isset($_POST['train_fare_confirm_checkout']))
    {
            ...
            $seat_feature = $_POST['seat_feature'];
            $seat_number = $_POST['seat_number'];

            //sql file to update the table of passengers with the new captured information
            $query = "INSERT INTO orrs_train_tickets (pass_name, pass_addr, pass_email, train_name, train_no, train_dep_stat, train_arr_stat, train_fare, fare_payment_code, seat_feature, seat_number)
            VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            ...
            $rc = $stmt->bind_param('sssssssssss', $pass_name, $pass_addr, $pass_email, $train_name, $train_no, $train_dep_stat, $train_arr_stat, $train_fare, $fare_payment_code, $seat_feature, $seat_number);
            $stmt->execute();
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Seat Feature</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                       <input class="form-control" readonly name="seat_feature" value="<?php echo $row->pass_seat_feature;?>" type="text">
                   </div>
</div>

<div class="form-group row">
  <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Seat Number</label>
  <div class="col-12 col-sm-8 col-lg-6">
    <input class="form-control" readonly name="seat_number" value="<?php echo $row->pass_seat_number;?>" type="text">
  </div>
</div>
